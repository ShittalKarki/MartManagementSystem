(() => {
    const tableBody = document.querySelector("#saleLinesTable tbody");
    ...
    const createRow = (index) => {
        ...
        tr.innerHTML = `
            ...
            <td><input class="form-control" name="Lines[${index}].DiscountPercent" type="number" min="0" max="100" step="0.01" value="0" required /></td>
            <td><input class="form-control" name="Lines[${index}].VatPercent" type="number" min="0" max="100" step="0.01" value="13" required /></td>
        ...
        const vatInput = tr.querySelector(`input[name='Lines[${index}].VatPercent']`);
        ...
        const setDefaults = () => {
            ...
            unitPriceInput.value = found.sellingPrice;
            vatInput.value = found.vatPercent;
        };
